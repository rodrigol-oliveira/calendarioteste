...
var addeventatc = function() {
    ...
    return {
        ...
        generate: function() {
            ...
            p ? addeventatc.applycss() : (addeventatc.removeelement($d("ate_css")), addeventatc.removeelement($d("ate_tmp_css")), addeventatc.helpercss()), m && !f && (f = !0, addeventatc.track({
                typ: "exposure",
                cal: ""
            }))
        },
        toogle: function(e, t) {
            ...
            if (n = $d(a = e.id)) {
                ...
                if ("ios" == addeventatc.agent() && "click" == t.type && "true" !== l && "false" !== i && (o = "appleical", n.setAttribute("data-intel-apple", "true")), "outlook" == o || "google" == o ||  "hotmail" == o || "outlookcom" == o || "appleical" == o || "apple" == o || "facebook" == o) "click" == t.type && (addeventatc.click({
                    button: a,
                    service: o,
                    id: t.id
                ...
                else if ("mouseover" == t.type && v != n && (g = !1), "click" == t.type || "render" == t.type || "mouseover" == t.type && !g) {
                    "mouseover" == t.type && (g = !0, null != H && addeventatc.trigger("button_mouseover", {
                        id: a
                    })), d = addeventatc.getburl({
                        id: a,
                        facebook: !0
                    }), "" == h && (h = "appleical,google");
                    for (var s = (h = (h += ",").replace(/ /gi, "")).split(","), r = 0; r < s.length; r += 1)(w && "ical" == s[r] || w && "appleical" == s[r]) && (c += '<span class="ateappleical" id="' + a + '-appleical" role="menuitem" tabindex="-1">' + T + "</span>"), x && "google" == s[r] && (c += '<span class="ategoogle" id="' + a + '-google" role="menuitem" tabindex="-1">' + z + "</span>"), b && "office365" == s[r] && (c += '<span class="ateoffice365" id="' + a + '-office365" role="menuitem" tabindex="-1">' + I + "</span>"), k && "outlook" == s[r] && (c += '<span class="ateoutlook" id="' + a + '-outlook" role="menuitem" tabindex="-1">' + C + "</span>"), (y && "hotmail" == s[r] || y && "outlookcom" == s[r]) && (c += '<span class="ateoutlookcom" id="' + a + '-outlookcom" role="menuitem" tabindex="-1">' + A + "</span>"), _ && "yahoo" == s[r] && (c += '<span class="ateyahoo" id="' + a + '-yahoo" role="menuitem" tabindex="-1">' + $ + "</span>"), d && "facebook" == s[r] && N && "facebook" == s[r] && (c += '<span class="atefacebook" id="' + a + '-facebook" role="menuitem" tabindex="-1">' + L + "</span>");
                    if (addeventatc.getlicense(u) || (c += '<em class="copyx"><em class="brx"></em><em class="frs"><a href="https://www.esporteinterativo.com.br" title="" tabindex="-1" id="' + a + '-home">Dev D&I and TI Turner</a></em></em>'), !$d(a + "-drop")) {
        ...
        click: function(e) {
            ...
            if (t = $d(e.button)) {
                if ("home" == e.service) n = "https://www.esporteinterativo.com.br/";
                else {
            ...
            if (a && n)
                if ("block" == addeventatc.getstyle(n, "display")) addeventatc.hideandreset();
                    ...
                    var l = parseInt(a.offsetHeight),
                        ...
                        N = "",
                        T = x.y - (r / 2 - l);
                    "down" == c && "left" == i ? (_ = y = "-2px", N = "topdown") : "up" == c && "left" == i ? (y = "0px", _ = -(r - l - 2) + "px") : "down" == c && "right" == i ? (y = -(p - s - 2) + "px", _ = "-2px", N = "topdown") : "up" == c && "right" == i ? (y = -(p - s - 2) + "px", _ = -(r - l - 2) + "px") : "auto" == c && "left" == i ? (y = "0px", T < g ? (_ = "-2px", N = "topdown") : _ = g + m < T + r ? -(r - l - 2) + "px" : -(r / 2 - l) + "px") : "auto" == c && "right" == i ? (y = -(p - s - 2) + "px", T < g ? (_ = "-2px", N = "topdown") : _ = g + m < T + r ? -(r - l - 2) + "px" : -(r / 2 - l) + "px") : "down" == c && "auto" == i ? (y = k < b ? -(p - s - 2) + "px" : "-2px", _ = "-2px", N = "topdown") : "up" == c && "auto" == i ? (y = k < b ? -(p - s - 2) + "px" : "-2px", _ = -(r - l - 2) + "px") : (T < g ? (_ = "-2px", N = "topdown") : _ = g + m < T + r ? -(r - l - 2) + "px" : -(r / 2 - l) + "px", y = k < b ? -(p - s - 2) + "px" : "-2px"), n.style.left = y, n.style.top = _, "" != N && (n.className = n.className + " " + N), setTimeout(function() {
